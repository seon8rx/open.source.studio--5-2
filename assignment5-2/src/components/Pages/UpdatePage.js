...
//         phone: "",
//     });
//     const [editCount, setEditCount] = useState(0); // 수정 횟수 저장
...
//             [name]: value,
//         }));
//         if (id) setEditCount((prevCount) => prevCount + 1); // 수정 시에만 수정 횟수 증가
//     };

//     const validateInputs = () => {
//         const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/; // 이메일 형식
//         const studentIdRegex = /^[0-9]+$/; // 숫자로만 구성
//         const phoneRegex = /^\d{3}-\d{2,4}-\d{4}$/; // 000-000-0000 또는 000-0000-0000
...
//         const url = id
//             ? `https://672e1dd5229a881691ef09f0.mockapi.io/api/students/students/${id}` // 수정
//             : "https://672e1dd5229a881691ef09f0.mockapi.io/api/students/students"; // 추가
